class FilesystemDisplay {
    constructor(opts) {
        ...
        this._defaultQuickLinks = () => {
            ...
            // and the standard ~/Desktop|Downloads|Documents… dirs. The APP tab
            // points at ~/Applications (the AppImage drop zone); the APPS virtual
            // folder / button were removed.
        ...
        // The former "APPS" virtual folder / button were removed: GUI-app
        // launching now lives on tab 5 (AppMonitorPanel) via the experimental
        // "显示GUI应用" setting. See appmonitorPanel.class.js.
        ...
        this.readFS = async dir => {
            ...
            // as real directories. (The apps:// view was removed.)
