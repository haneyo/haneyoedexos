...
Weather.icons = {
    ...
    fog: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M6.8 8.5h10.4a3.6 3.6 0 0 0 .8-7.1 4.6 4.6 0 0 0-9-1A4 4 0 0 0 6.8 8.5z"/><path d="M4 13h16M4 16h16M4 19h16"/></svg>`,
    drizzle: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M6.8 11h10.4a3.6 3.6 0 0 0 .8-7.1 4.6 4.6 0 0 0-9-1A4 4 0 0 0 6.8 11z"/><path d="M8.5 15l-.8 2M12 15.2l-.8 2M15.5 15l-.8 2"/></svg>`,
    rain: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M6.8 11h10.4a3.6 3.6 0 0 0 .8-7.1 4.6 4.6 0 0 0-9-1A4 4 0 0 0 6.8 11z"/><path d="M7.5 15l-1.2 3M11.2 15l-1.2 3M14.9 15l-1.2 3M18.6 15l-1.2 3"/></svg>`,
    snow: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M6.8 11h10.4a3.6 3.6 0 0 0 .8-7.1 4.6 4.6 0 0 0-9-1A4 4 0 0 0 6.8 11z"/><path d="M12 14.5v4.5M9.7 15.5l4.6 2.6M14.3 15.5l-4.6 2.6"/></svg>`,
    thunder: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M6.8 11h10.4a3.6 3.6 0 0 0 .8-7.1 4.6 4.6 0 0 0-9-1A4 4 0 0 0 6.8 11z"/><path d="M12.8 13 9.6 18h2.6l-1.6 3.5 4-5h-2.7z"/></svg>`
};
