...
const SYSTEM_APP_RE = /(^|[\s_.\/-])(uxterm|xterm|x-terminal-emulator|fcitx5|fcitx|gsettings|gdbus|dbus-|gnome-terminal|gnome-control-center|gnome-system-monitor|gnome-software|gnome-disks|gnome-calculator|gnome-calendar|gnome-characters|gnome-clocks|gnome-connections|gnome-contacts|gnome-documents|gnome-files|gnome-fonts|gnome-logs|gnome-maps|gnome-music|gnome-photos|gnome-power-statistics|gnome-screenshot|gnome-tweaks|gnome-weather|gnome-text-editor|gedit|nautilus|yelp|blueman|onboard|openbox|pcmanfm|thunar|xfce4-terminal|mousepad|picom|compton|avahi-|python3|konsole|dolphin|kwrite|ark|kcalc|kgpg|kcolorchooser|kcharselect|kfind|kolourpaint|systemsettings|org\.gnome\.|org\.kde\.|im-config|kbd-layout|links2|xlinks2|x11vnc|gcr-|gcr-prompter|gcr-viewer|notification-daemon|obconf|byobu|htop|aerc|btop|vim|geoclue|snap-|xdg-desktop-portal|zenity|^info$)([\s_.\/-]|$)/i;
